...
{
    public interface ICidadesService : IService<CIDADE>
    {
        Dictionary<DateTime, int> GetItemsCount(DateTime datetime);
        Dictionary<Category, int> GetCategoryCount();
    }

    public class CidadesService : Service<CIDADE>, ICidadesService
    {
        public CidadesService(IRepositoryAsync<CIDADE> repository)
            : base(repository)
        {
        }
        ...
        Dictionary<DateTime, int> ICidadesService.GetItemsCount(DateTime datetime)
        {
            throw new NotImplementedException();
        }
    }
