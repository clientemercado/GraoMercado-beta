...
namespace BeYourMarket.Web.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public PaymentController(
            ...
            IRespostaFornecedoresCotacaoService respostaFornecedoresCotacaoService, IListingService listingService,
        ...
        public async Task<ActionResult> Orders(int oqeq)
        {
        ...
        public ActionResult PaymentSetting(int oqeq)
        {
            ViewBag.oqeq = (oqeq >= 0) ? oqeq : 0;
        ...
        public async Task<ActionResult> Transaction(int oqeq)
        {
            ViewBag.oqeq = (oqeq >= 0) ? oqeq : 0;
